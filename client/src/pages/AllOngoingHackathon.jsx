...
import { openHackathons } from "../assets/assets";
  ...
  return (
    <div>
      <div className='flex flex-col gap-6 bg-gray-900 h-72 px-20 justify-center'>
        <button className='bg-pink-300  p-2 rounded-lg hover:bg-pink-400 transition-all text-lg font-semibold cursor-pointer w-fit text-pink-600 flex items-center gap-2' onClick={() => navigate('/hackathon')}>
      ...
      <div className='flex justify-between items-center mb-6'>
        ...
        <button className='bg-pink-300 border-2 border-pink-300 p-2 text-white rounded-lg hover:bg-pink-400 transition-all text-lg font-semibold cursor-pointer' onClick={() => navigate('/ongoing-hackathons')}>
